...
import type { NavUserInfo } from "@/app/(main)/dashboard/_components/sidebar/nav-user";
...
async function getCurrentUser(): Promise<NavUserInfo> {
  try {
  ...
  return { name: "Pengguna", email: "", avatar: "", isSuperuser: false, groups: [] };
}
