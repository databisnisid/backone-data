...
class MembersAdmin(ModelAdmin):
    ...
    def get_list_display(self, request):
        if request.user.is_superuser:
            list_display = ('name_with_parameters', 'address_and_services', 'online_at', 'offline_at', 'get_links_html', 'upload_baa', 'notes')
        else:
            list_display = ('name_with_network', 'address_and_services', 'online_at', 'get_links_html', 'upload_baa', 'notes')
